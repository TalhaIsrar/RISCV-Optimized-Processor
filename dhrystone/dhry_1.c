...
/* Main and Proc_0 in the Ada version             */
{
  ...
  User_Cycles = End_Time - Begin_Time;
  ...
  {
    Cycles_Per_Run = User_Cycles / Number_Of_Runs;

    #ifdef CPU_FREQ_HZ
      Dhrystones_Per_Second = CPU_FREQ_HZ / Cycles_Per_Run;
      Microseconds_Per_Run =
          (Cycles_Per_Run * 1000000) / CPU_FREQ_HZ;
    #endif
    // Print table
    uart_puts("\n--- Dhrystone Results ---\n");
