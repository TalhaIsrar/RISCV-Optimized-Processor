module riscv_m_unit(
    ...
    logic[31:0] rs1_select, rs2_select;
    ...
    assign is_signed = (funct3 == 3'b000) ||  // MUL
                       (funct3 == 3'b001) ||  // MULH
                       (funct3 == 3'b100) ||  // DIV
                       (funct3 == 3'b110);    // REM
    ...
    radix2_divider radix4_divider_inst (
        .clk(clk),
        .rst(rst),
        .start(div_start),
        .dividend(rs1_r),
    ...
    assign result = inst_type[2] ? mul_result : inst_type[1] ? quotient : remainder;
