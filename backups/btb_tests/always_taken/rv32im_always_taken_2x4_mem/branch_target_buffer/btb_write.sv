module btb_write(
    ...
    input logic [3:0] LRU,
    input logic [27:0] update_tag,
    input logic [1:0] update_index,
    ...
    wire [27:0] write_tag1, write_tag2;
    ...
    assign tag1 = branch1[62:35];
    assign tag2 = branch2[62:35];

    assign target1 = branch1[34:3];
    assign target2 = branch2[34:3];
    ...
    assign write_set = { write_valid1, write_tag1, write_target1, write_state1, 1'b0,
                         write_valid2, write_tag2, write_target2, write_state2, 1'b0};
