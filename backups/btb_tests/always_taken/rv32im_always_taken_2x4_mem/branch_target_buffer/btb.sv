module btb(
    ...
    // Update Signals
    wire [1:0] update_index;
    wire [27:0] update_tag;
    wire [127:0] update_set;  
    wire [127:0] write_set;

    // LRU Signals
    wire [3:0] LRU, next_LRU;
    wire next_LRU_read;
    wire next_LRU_write;
    ...
    assign read_index = pc[3:2];
    assign read_tag = pc[31:4];

    assign update_index = update_pc[3:2];
