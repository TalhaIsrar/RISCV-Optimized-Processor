module btb_write(
    ...
    wire [25:0] write_tag1, write_tag2;
    ...
    assign tag1 = branch1[62:37];
    assign tag2 = branch2[62:37];

    assign target1 = branch1[36:5];
    assign target2 = branch2[36:5];
    ...
    assign write_set = { write_valid1, write_tag1, write_target1, write_state1, 3'b000,
                         write_valid2, write_tag2, write_target2, write_state2, 3'b000};
